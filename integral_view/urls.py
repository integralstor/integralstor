...
urlpatterns = patterns('',
    ...
    url(r'^$', login),
    url(r'^update_admin_password/', login_required(update_admin_password)),
    url(r'^view_email_settings/', login_required(view_email_settings)),
    url(r'^update_email_settings/', login_required(update_email_settings)),
    url(r'^view_https_mode/', login_required(view_https_mode)),
    url(r'^update_https_mode/', login_required(update_https_mode)),
    ...
    url(r'^update_cifs_share/', login_required(update_cifs_share)),
    url(r'^delete_cifs_share/', login_required(delete_cifs_share)),
    url(r'^create_cifs_share/', login_required(create_cifs_share)),
    url(r'^view_samba_server_settings/', login_required(view_samba_server_settings)),
    url(r'^update_samba_server_settings/', login_required(update_samba_server_settings)),
    url(r'^update_auth_method/', login_required(update_auth_method)),

    #From views/common.py
    ...
    url(r'^view_dashboard/([A-Za-z0-9_]+)', login_required(view_dashboard)),
    url(r'^access_shell/', login_required(access_shell)),

    #From views/folder_management.py
    url(r'view_dir_contents/',login_required(view_dir_contents)),
    ...
    url(r'^view_dir_listing/', login_required(view_dir_listing)),
    url(r'^view_dir_manager/', login_required(view_dir_manager)),
    url(r'^view_dir_ownership_permissions/', login_required(view_dir_ownership_permissions)),
    url(r'^update_dir_owner/', login_required(update_dir_owner)),
    url(r'^update_dir_permissions', login_required(update_dir_permissions)),
    url(r'^update_sticky_bit/', login_required(update_sticky_bit)),

    #From views/ftp_management.py
    url(r'^view_ftp_configuration', login_required(view_ftp_configuration)),
    url(r'^update_ftp_configuration', login_required(update_ftp_configuration)),
    ...
    url(r'^update_local_user_group_membership/', login_required(update_local_user_group_membership)),
    ...
    url(r'^update_local_user_password/', login_required(update_local_user_password)),
    url(r'^update_group_membership/', login_required(update_group_membership)),
    ...
    url(r'^update_interface_state/', login_required(update_interface_state)),
    url(r'^view_bond/', login_required(view_bond)),
    url(r'^update_interface_address/', login_required(update_interface_address)),
    ...
    url(r'^update_dns_nameservers/', login_required(update_dns_nameservers)),
    ...
    url(r'^update_nfs_share/', login_required(update_nfs_share)),
    ...
    url(r'^update_ntp_settings/', login_required(update_ntp_settings)),
    ...
    url(r'^view_user_ssh_keys',login_required(view_user_ssh_keys)),
    url(r'^view_known_hosts_ssh_keys',login_required(view_known_hosts_ssh_keys)),

    #From views/rsync_share_management.py
    url(r'^create_rsync_share',login_required(create_rsync_share)),
    url(r'^update_rsync_share',login_required(update_rsync_share)),
    ...
    url(r'^delete_background_task/', login_required(delete_background_task)),
    ...
    url(r'^update_service_status/', login_required(update_service_status)),
    ...
    url(r'^create_iscsi_user_authentication/', login_required(create_iscsi_user_authentication)),
    url(r'^delete_iscsi_user_authentication/', login_required(delete_iscsi_user_authentication)),
    url(r'^create_iscsi_acl/', login_required(create_iscsi_acl)),
    url(r'^delete_iscsi_acl/', login_required(delete_iscsi_acl)),
    ...
    url(r'^update_remote_replication/', login_required(update_remote_replication)),
    url(r'^delete_remote_replication/', login_required(delete_remote_replication)),
    ...
    url(r'^update_zfs_quota/', login_required(update_zfs_quota)),
    url(r'^delete_zfs_quota/', login_required(delete_zfs_quota)),
    ...
    url(r'^update_zfs_l2arc/', login_required(update_zfs_l2arc)),
    url(r'^delete_zfs_l2arc/', login_required(delete_zfs_l2arc)),
    url(r'^view_zfs_dataset/', login_required(view_zfs_dataset)),
    url(r'^update_zfs_dataset/', login_required(update_zfs_dataset)),
    ...
    url(r'^create_zfs_spares/', login_required(create_zfs_spares)),
