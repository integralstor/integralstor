...
def clear_zfs_pool(request):
    ...
    try:
        ...
        return_dict["name"] = name
        if request.method == "GET":
            return django.http.HttpResponseRedirect('/storage/view_zfs_pools/')
        else:
    ...
    try:
        ...
        if request.method == "GET":
            ...
            if type == 'filesystem':
                ...
                return django.http.HttpResponseRedirect('/storage/view_zfs_pool?ack=dataset_deleted&name=%s' % pool_name)
            else:
