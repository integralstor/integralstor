...
def get_logs(date_on=None, date_from=None, date_till=None, last_backup_only=None):
    logs = []
    qry = ''
    client_id_list = []
    try:
...
def compile_report(date_on=None, date_from=None, date_till=None, last_backup_only=None):
    l = []
    try:
        urb_db, err = config.get_urbackup_db_path()
        if err:
