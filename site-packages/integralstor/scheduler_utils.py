...
def create_cron_task(command, description, min="1", hour='*', day='*', dow='*', month='*', user='root', task_type_id=0):
    cron_task_id = None
    try:
...
def get_cron_tasks(cron_task_id=None, user='root', task_type_id=None):
